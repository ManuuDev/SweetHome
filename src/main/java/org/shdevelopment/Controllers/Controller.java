...
public class Controller {
    ...
    public void initConfig() {
        ...
        webEngine.load(String.valueOf(Controller.class.getResource("/chat.html")));
    ...
    private void configureDragAndDrop() {
        ...
        dragAndDropImage.setOnDragExited(event -> {
            dragAndDropImage.setVisible(false);
            event.consume();
        });
    }
    ...
    public void sendFilesToAllContacts() {
        ...
        if (fileList != null) {
            Runnable runnable = () -> StatelessContactBook.getInstance().getCopyOfContactBook().forEach((contact) -> Client.fileHandler(contact.getIp(), fileList));
            executeTask(runnable);
        }
    }
